        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SerialNumber = table.Column<string>(type: "character varying(25)", maxLength: 25, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StorageLevels_StorageLevels_ParentStorageLevelId",
                        column: x => x.ParentStorageLevelId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StorageLevels_ParentStorageLevelId",
                table: "StorageLevels",
                column: "ParentStorageLevelId");
        }
